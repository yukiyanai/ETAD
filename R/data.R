#' ETAD data
#'
#' Data of Election Timing across Autocracy and Democracy
#'
#' @format ## `ETAD`
...
#'   \item{reason}{Categorical variable showing the resons for the election-timing change. `0` = no change, `1` = the first election under the new constitution or for the new state, `2` = re-election due to an invalid election, `3` = coup, `4` = natural death of the leader, `5` = the leader was assassinated, `6` = civil war, `9` = other.}
