...
It currently covers national legislative and presidential the periods between 1945 and 2022 for 146 countries.
...
Then, you can use the data object called `ETAD`. For instance, you can glance at
the top rows of the dataset by:
```{r}
head(ETAD)
```

If you would like to use the dataset outside R, please download the dataset.
...
To save it in dta format for Stata 14 (you need **haven** package for this):
```{r}
...
- [Masaaki Higashijima](https://masaakihigashijima.com/) (University of Tokyo)
